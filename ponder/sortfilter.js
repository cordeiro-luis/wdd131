...
function compareFnProductName(a, b) {
...
let productSort = products.sort(compareFnProduct);

console.log(productSort);

let productNameSort = products.sort(compareFnProductName);
